...
class CrearEmpleadoDepartamentoInexistenteIntegrationTest extends BaseIntegrationTest {

    @Test
    void shouldFailWhenDepartamentoDoesNotExist() {
        EmpleadoRequest request = new EmpleadoRequest();
        request.setNombre("Luis");
        request.setDireccion("Calle 9");
        request.setTelefono("555-909");
        request.setDepartamentoClave("INEXISTENTE");
